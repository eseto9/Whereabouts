...
const RIDDLES={
  ...
  'the Knead to Know bakery':['Bread and buns come out of my oven every morning.'],
  'the Curl Up & Dye barbershop':['My striped pole spins outside, and hair gets snipped inside.'],
  'Fin’s Fish shop':['I sell the catch of the day, fresh from the sea.'],
  'the Codfather fish shop':['I sell the catch of the day, fresh from the sea.'],
  'the Just Toying toy shop':['Kids press their noses to my window to see wind-ups and teddies.'],
  'the Petal Pushers flower shop':['Everything I sell smells lovely, and it all came from a garden.'],
  'the Frock & Roll clothes shop':['I’m where you spend your coins on something new to wear.'],
  // Harbor
  'the Plaice to Be fish shack':['I serve fish and chips by the sea, wrapped in paper.'],
