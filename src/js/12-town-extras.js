...
function buildExtras(){
  ...
  {const g=new THREE.Group();g.add(at(box(0.9,0.55,0.55,'#C8D4E0',{w:0.015}),0,0.75,0));for(const x of[-0.35,0.35])for(const z of[-0.2,0.2])g.add(at(sph(0.06,'#2B2040',5,4,{ol:false}),x,0.08,z));
   ...
   place(g,36.6,7.9,0.6,{k:'trolley',n:'the shopping trolley',c:['silver','red'],s:'boxy',m:'metal',v:'a bit wobbly',snd:'rattle',u:'wheel your shopping in',e:'🛒🍎🥕',r:['I have four wobbly wheels and a basket you push around the shops.']},{solid:false,exact:true,ry:0.6});}
